...
const Banner = () => {
  return (
    <div className="hero bg-base-200 h-[400px] md:h-[600px]">
      <div className="hero-content text-center">
        <div>
          ...
          <p className="py-6 w-full md:w-3/4 mx-auto">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam modi
            asperiores cumque veritatis quas voluptate accusantium a ipsam nihil
            assumenda.
          </p>
